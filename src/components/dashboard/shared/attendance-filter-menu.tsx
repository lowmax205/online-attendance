...
export function AttendanceFilterMenu({
  ...
  } = useAcademicPrograms(values.department);
  ...
  const departmentValue = selectedDepartment || "all";
  const courseValue = draft.course ?? "";
  const isCourseDisabled =
    isLoading || !selectedDepartment || selectedDepartment === "all";
  const filteredCourseOptions =
    !selectedDepartment || selectedDepartment === "all" ? [] : courseOptions;
        ...
        <div className="p-4 space-y-4">
          <div className="grid grid-cols-1 gap-4">
            ...
            {showDepartmentFilters && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="attendance-department">
                    Department/Colleges
                  </Label>
                  <Select
                    ...
                    disabled={isLoading}
                  >
                    <SelectTrigger id="attendance-department">
                ...
                <div className="space-y-2">
                  <Label htmlFor="attendance-course">Course/Program</Label>
                  <Select
                    value={courseValue}
                    onValueChange={(value) =>
                      setDraft((prev) => ({
